...
procedure TPresentValueScreen.OnPrint( Header: TStringList );
var
  yPos: integer;
  PenWidth: integer;
...
begin
  ...
  Label3.Left := Trunc(PresentValueGrid.Width*0.42);
  Label4.Left := Trunc(PresentValueGrid.Width*0.59);
  Label5.Left := Trunc(PresentValueGrid.Width*0.77);
  // AdvancedGroup
